...
var toObject = __webpack_require__(14);
var fails = __webpack_require__(4);
var sloppyArrayMethod = __webpack_require__(52);
...
var es_object_assign = __webpack_require__(83);
...
var es_string_includes = __webpack_require__(69);
...
var es_array_map = __webpack_require__(111);
...
var support_postRequest = function postRequest(endpoint, data) {
  var response;
  return regenerator_default.a.async(function postRequest$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regenerator_default.a.awrap(fetch("".concat(apiUrl).concat(endpoint), {
            method: 'POST',
        ...
        case 2:
          ...
          _context.next = 6;
          return regenerator_default.a.awrap(response.json());
...
var cloud_storage_saveCloudGoal = function saveCloudGoal(name, options) {
  var data;
  return regenerator_default.a.async(function saveCloudGoal$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return regenerator_default.a.awrap(support_postRequest("/goals/unlock", data));
...
var cloud_storage_loadFromCloud = function loadFromCloud(goals, options) {
  var data, response;
  return regenerator_default.a.async(function loadFromCloud$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          addAuthData(data, options);
          _context2.next = 5;
          return regenerator_default.a.awrap(support_postRequest("/sessions", data));
...
var es_date_to_string = __webpack_require__(126);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.parse-int.js
var es_parse_int = __webpack_require__(127);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.regexp.to-string.js
var es_regexp_to_string = __webpack_require__(130);
...
var achievements_unlockGoal = function unlockGoal(name, goals, options) {
  return regenerator_default.a.async(function unlockGoal$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          if (!(!goals || !goals[name])) {
        ...
        case 4:
          ...
          _context.next = 9;
          return regenerator_default.a.awrap(cloud_storage_saveCloudGoal(name, options));
...
var buttons_initButtons = function initButtons(goals, options) {
  document.addEventListener('click', function (event) {
    if (event.target.dataset.simplegoalsUnlock) {
      ...
      achievements_unlockGoal(event.target.dataset.simplegoalsUnlock, goals, options);
    }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "unlock", function() { return src_unlock; });
...
var src_goals = null;
var src_init = function init(config) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return regenerator_default.a.awrap(cloud_storage_loadFromCloud(src_goals, src_options));
...
var src_unlock = function unlock(name) {
  return regenerator_default.a.async(function unlock$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          achievements_unlockGoal(name, src_goals, src_options);
